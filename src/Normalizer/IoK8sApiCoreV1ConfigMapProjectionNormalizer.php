...
class IoK8sApiCoreV1ConfigMapProjectionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1ConfigMapProjection::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1ConfigMapProjection::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1ConfigMapProjection();
    ...
    {
        return [\Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1ConfigMapProjection::class => false];
    }
}
