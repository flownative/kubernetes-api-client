...
class IoK8sApiCoreV1ServiceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Service::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Service::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Service();
        ...
        if (\array_key_exists('spec', $data) && $data['spec'] !== null) {
            $object->setSpec($this->denormalizer->denormalize($data['spec'], \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1ServiceSpec::class, 'json', $context));
        } elseif (\array_key_exists('spec', $data) && $data['spec'] === null) {
            $object->setSpec(null);
        }
        if (\array_key_exists('status', $data) && $data['status'] !== null) {
            $object->setStatus($this->denormalizer->denormalize($data['status'], \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1ServiceStatus::class, 'json', $context));
    ...
    {
        return [\Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Service::class => false];
    }
}
