...
class IoK8sApiCoreV1EphemeralContainerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1EphemeralContainer::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1EphemeralContainer::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1EphemeralContainer();
        ...
        if (\array_key_exists('targetContainerName', $data) && $data['targetContainerName'] !== null) {
            $object->setTargetContainerName($data['targetContainerName']);
        } elseif (\array_key_exists('targetContainerName', $data) && $data['targetContainerName'] === null) {
            $object->setTargetContainerName(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('targetContainerName') && null !== $data->getTargetContainerName()) {
            $dataArray['targetContainerName'] = $data->getTargetContainerName();
        }
    ...
    {
        return [\Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1EphemeralContainer::class => false];
    }
}
