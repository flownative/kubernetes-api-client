...
class IoK8sApiCoreV1PodNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Pod::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Pod::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Pod();
        ...
        if (\array_key_exists('spec', $data) && $data['spec'] !== null) {
            $object->setSpec($this->denormalizer->denormalize($data['spec'], \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1PodSpec::class, 'json', $context));
        } elseif (\array_key_exists('spec', $data) && $data['spec'] === null) {
            $object->setSpec(null);
        }
        if (\array_key_exists('status', $data) && $data['status'] !== null) {
            $object->setStatus($this->denormalizer->denormalize($data['status'], \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1PodStatus::class, 'json', $context));
    ...
    {
        return [\Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Pod::class => false];
    }
}
