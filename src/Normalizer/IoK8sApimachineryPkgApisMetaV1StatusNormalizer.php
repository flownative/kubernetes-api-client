...
class IoK8sApimachineryPkgApisMetaV1StatusNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Flownative\Kubernetes\Api\Model\IoK8sApimachineryPkgApisMetaV1Status::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Flownative\Kubernetes\Api\Model\IoK8sApimachineryPkgApisMetaV1Status::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Flownative\Kubernetes\Api\Model\IoK8sApimachineryPkgApisMetaV1Status();
        ...
        if (\array_key_exists('details', $data) && $data['details'] !== null) {
            $object->setDetails($this->denormalizer->denormalize($data['details'], \Flownative\Kubernetes\Api\Model\IoK8sApimachineryPkgApisMetaV1StatusDetails::class, 'json', $context));
    ...
    {
        return [\Flownative\Kubernetes\Api\Model\IoK8sApimachineryPkgApisMetaV1Status::class => false];
    }
}
