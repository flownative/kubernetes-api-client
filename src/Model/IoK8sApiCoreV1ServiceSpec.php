...
class IoK8sApiCoreV1ServiceSpec
{
     ...
     * @var bool|null
     */
    protected $allocateLoadBalancerNodePorts;
    /**
     ...
     * @var string|null
     */
    protected $externalTrafficPolicy;
    /**
     ...
     * @var list<string>|null
     */
    protected $loadBalancerSourceRanges;
    /**
     * The list of ports that are exposed by this service. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies.
     *
     * @var list<IoK8sApiCoreV1ServicePort>|null
     */
    protected $ports;
    /**
     ...
     * @var bool|null
     */
    protected $publishNotReadyAddresses;
    /**
     ...
     * @var string|null
     */
    protected $sessionAffinity;
    /**
     * SessionAffinityConfig represents the configurations of session affinity.
     *
     * @var IoK8sApiCoreV1SessionAffinityConfig|null
     */
    protected $sessionAffinityConfig;
    /**
     * TrafficDistribution offers a way to express preferences for how traffic is distributed to Service endpoints. Implementations can use this field as a hint, but are not required to guarantee strict adherence. If the field is not set, the implementation will apply its default routing strategy. If set to "PreferClose", implementations should prioritize endpoints that are in the same zone.
     *
     * @var string|null
     */
    protected $trafficDistribution;
    /**
     ...
     * allocateLoadBalancerNodePorts defines if NodePorts will be automatically allocated for services with type LoadBalancer.  Default is "true". It may be set to "false" if the cluster load-balancer does not rely on NodePorts.  If the caller requests specific NodePorts (by specifying a value), those requests will be respected, regardless of this field. This field may only be set for services with type LoadBalancer and will be cleared if the type is changed to any other type.
     */
    public function getAllocateLoadBalancerNodePorts(): ?bool
    {
    ...
    {
        $this->initialized['allocateLoadBalancerNodePorts'] = true;
     ...
     * This field may hold a maximum of two entries (dual-stack IPs, in either order). These IPs must correspond to the values of the ipFamilies field. Both clusterIPs and ipFamilies are governed by the ipFamilyPolicy field. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies
     *
     * @param list<string>|null $clusterIPs
     */
    public function setClusterIPs(?array $clusterIPs): self
    {
        $this->initialized['clusterIPs'] = true;
     ...
     * externalIPs is a list of IP addresses for which nodes in the cluster will also accept traffic for this service.  These IPs are not managed by Kubernetes.  The user is responsible for ensuring that traffic arrives at a node with this IP.  A common example is external load-balancers that are not part of the Kubernetes system.
     *
     * @param list<string>|null $externalIPs
     */
    public function setExternalIPs(?array $externalIPs): self
    {
        $this->initialized['externalIPs'] = true;
    ...
    {
        $this->initialized['externalTrafficPolicy'] = true;
    ...
    {
        $this->initialized['healthCheckNodePort'] = true;
    ...
    {
        $this->initialized['internalTrafficPolicy'] = true;
     ...
     * This field may hold a maximum of two entries (dual-stack families, in either order).  These families must correspond to the values of the clusterIPs field, if specified. Both clusterIPs and ipFamilies are governed by the ipFamilyPolicy field.
     *
     * @param list<string>|null $ipFamilies
     */
    public function setIpFamilies(?array $ipFamilies): self
    {
        $this->initialized['ipFamilies'] = true;
    ...
    {
        $this->initialized['ipFamilyPolicy'] = true;
    ...
    {
        $this->initialized['loadBalancerClass'] = true;
    ...
    {
        $this->initialized['loadBalancerIP'] = true;
     ...
     * If specified and supported by the platform, this will restrict traffic through the cloud-provider load-balancer will be restricted to the specified client IPs. This field will be ignored if the cloud-provider does not support the feature." More info: https://kubernetes.io/docs/tasks/access-application-cluster/create-external-load-balancer/.
     *
     * @param list<string>|null $loadBalancerSourceRanges
     */
    public function setLoadBalancerSourceRanges(?array $loadBalancerSourceRanges): self
    {
        $this->initialized['loadBalancerSourceRanges'] = true;
     ...
     * The list of ports that are exposed by this service. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies.
     *
     * @return list<IoK8sApiCoreV1ServicePort>|null
     */
     ...
     * The list of ports that are exposed by this service. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies.
     *
     * @param list<IoK8sApiCoreV1ServicePort>|null $ports
     */
    ...
    {
        $this->initialized['publishNotReadyAddresses'] = true;
     ...
     */
    public function getSelector(): ?iterable
    {
     ...
     */
    public function setSelector(?iterable $selector): self
    {
    ...
    {
        $this->initialized['sessionAffinity'] = true;
     ...
     * SessionAffinityConfig represents the configurations of session affinity.
     */
    public function getSessionAffinityConfig(): ?IoK8sApiCoreV1SessionAffinityConfig
    {
     ...
     * SessionAffinityConfig represents the configurations of session affinity.
     */
    public function setSessionAffinityConfig(?IoK8sApiCoreV1SessionAffinityConfig $sessionAffinityConfig): self
    {
        $this->initialized['sessionAffinityConfig'] = true;
     ...
     * TrafficDistribution offers a way to express preferences for how traffic is distributed to Service endpoints. Implementations can use this field as a hint, but are not required to guarantee strict adherence. If the field is not set, the implementation will apply its default routing strategy. If set to "PreferClose", implementations should prioritize endpoints that are in the same zone.
     */
    public function getTrafficDistribution(): ?string
    {
     ...
     * TrafficDistribution offers a way to express preferences for how traffic is distributed to Service endpoints. Implementations can use this field as a hint, but are not required to guarantee strict adherence. If the field is not set, the implementation will apply its default routing strategy. If set to "PreferClose", implementations should prioritize endpoints that are in the same zone.
     */
    public function setTrafficDistribution(?string $trafficDistribution): self
    {
        $this->initialized['trafficDistribution'] = true;
