...
class IoK8sApiCoreV1TopologySpreadConstraint
{
    ...
    {
        $this->initialized['minDomains'] = true;
    ...
    {
        $this->initialized['nodeAffinityPolicy'] = true;
    ...
    {
        $this->initialized['nodeTaintsPolicy'] = true;
    ...
    {
        $this->initialized['whenUnsatisfiable'] = true;
