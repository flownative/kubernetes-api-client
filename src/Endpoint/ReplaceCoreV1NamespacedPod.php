...
class ReplaceCoreV1NamespacedPod extends \Flownative\Kubernetes\Api\Runtime\Client\BaseEndpoint implements \Flownative\Kubernetes\Api\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(string $name, string $namespace, \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Pod $body, array $queryParameters = [])
    {
        $this->name = $name;
    ...
    {
        return str_replace(['{name}', '{namespace}'], [$this->name, $this->namespace], '/api/v1/namespaces/{namespace}/pods/{name}');
    }
    ...
    /**
     * @return \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Pod
     *
     * @throws \Flownative\Kubernetes\Api\Exception\ReplaceCoreV1NamespacedPodUnauthorizedException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            return $serializer->deserialize($body, 'Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Pod', 'json');
        }
        if (201 === $status) {
            return $serializer->deserialize($body, 'Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Pod', 'json');
        }
        if (401 === $status) {
            throw new \Flownative\Kubernetes\Api\Exception\ReplaceCoreV1NamespacedPodUnauthorizedException($response);
        }
