...
class ListCoreV1NamespacedPod extends \Flownative\Kubernetes\Api\Runtime\Client\BaseEndpoint implements \Flownative\Kubernetes\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{namespace}'], [$this->namespace], '/api/v1/namespaces/{namespace}/pods');
    }
    ...
    /**
     * @return \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1PodList
     *
     * @throws \Flownative\Kubernetes\Api\Exception\ListCoreV1NamespacedPodUnauthorizedException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            return $serializer->deserialize($body, 'Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1PodList', 'json');
        }
        if (401 === $status) {
            throw new \Flownative\Kubernetes\Api\Exception\ListCoreV1NamespacedPodUnauthorizedException($response);
        }
