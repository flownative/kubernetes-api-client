...
class DeleteCoreV1NamespacedConfigMap extends \Flownative\Kubernetes\Api\Runtime\Client\BaseEndpoint implements \Flownative\Kubernetes\Api\Runtime\Client\Endpoint
{
    ...
    /**
     * @return \Flownative\Kubernetes\Api\Model\IoK8sApimachineryPkgApisMetaV1Status
     *
     * @throws \Flownative\Kubernetes\Api\Exception\DeleteCoreV1NamespacedConfigMapUnauthorizedException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            return $serializer->deserialize($body, 'Flownative\Kubernetes\Api\Model\IoK8sApimachineryPkgApisMetaV1Status', 'json');
        }
        if (202 === $status) {
            return $serializer->deserialize($body, 'Flownative\Kubernetes\Api\Model\IoK8sApimachineryPkgApisMetaV1Status', 'json');
        }
        if (401 === $status) {
            throw new \Flownative\Kubernetes\Api\Exception\DeleteCoreV1NamespacedConfigMapUnauthorizedException($response);
        }
