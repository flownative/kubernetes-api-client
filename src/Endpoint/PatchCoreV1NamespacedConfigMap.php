...
class PatchCoreV1NamespacedConfigMap extends \Flownative\Kubernetes\Api\Runtime\Client\BaseEndpoint implements \Flownative\Kubernetes\Api\Runtime\Client\Endpoint
{
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['pretty', 'dryRun', 'fieldManager', 'fieldValidation', 'force']);
     ...
     *
     * @throws \Flownative\Kubernetes\Api\Exception\PatchCoreV1NamespacedConfigMapUnauthorizedException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (401 === $status) {
            throw new \Flownative\Kubernetes\Api\Exception\PatchCoreV1NamespacedConfigMapUnauthorizedException($response);
        }
