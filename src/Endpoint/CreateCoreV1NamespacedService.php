...
class CreateCoreV1NamespacedService extends \Flownative\Kubernetes\Api\Runtime\Client\BaseEndpoint implements \Flownative\Kubernetes\Api\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(string $namespace, \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Service $body, array $queryParameters = [])
    {
     ...
     *
     * @throws \Flownative\Kubernetes\Api\Exception\CreateCoreV1NamespacedServiceUnauthorizedException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (401 === $status) {
            throw new \Flownative\Kubernetes\Api\Exception\CreateCoreV1NamespacedServiceUnauthorizedException($response);
        }
