...
class ListAppsV1NamespacedDeployment extends \Flownative\Kubernetes\Api\Runtime\Client\BaseEndpoint implements \Flownative\Kubernetes\Api\Runtime\Client\Endpoint
{
     ...
     *           }
     */
    public function __construct(string $namespace, array $queryParameters = [])
    {
    ...
    {
        return str_replace(['{namespace}'], [$this->namespace], '/apis/apps/v1/namespaces/{namespace}/deployments');
    }
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['pretty', 'allowWatchBookmarks', 'continue', 'fieldSelector', 'labelSelector', 'limit', 'resourceVersion', 'resourceVersionMatch', 'sendInitialEvents', 'timeoutSeconds', 'watch']);
    ...
    /**
     * @return \Flownative\Kubernetes\Api\Model\IoK8sApiAppsV1DeploymentList
     *
     * @throws \Flownative\Kubernetes\Api\Exception\ListAppsV1NamespacedDeploymentUnauthorizedException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            return $serializer->deserialize($body, 'Flownative\Kubernetes\Api\Model\IoK8sApiAppsV1DeploymentList', 'json');
        }
        if (401 === $status) {
            throw new \Flownative\Kubernetes\Api\Exception\ListAppsV1NamespacedDeploymentUnauthorizedException($response);
        }
