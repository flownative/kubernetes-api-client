...
class PatchCoreV1Namespace extends \Flownative\Kubernetes\Api\Runtime\Client\BaseEndpoint implements \Flownative\Kubernetes\Api\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(string $name, \stdClass $body, array $queryParameters = [])
    {
        $this->name = $name;
        $this->body = $body;
     ...
     *
     * @throws \Flownative\Kubernetes\Api\Exception\PatchCoreV1NamespaceUnauthorizedException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (401 === $status) {
            throw new \Flownative\Kubernetes\Api\Exception\PatchCoreV1NamespaceUnauthorizedException($response);
        }
