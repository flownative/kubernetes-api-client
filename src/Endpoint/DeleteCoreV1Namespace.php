...
class DeleteCoreV1Namespace extends \Flownative\Kubernetes\Api\Runtime\Client\BaseEndpoint implements \Flownative\Kubernetes\Api\Runtime\Client\Endpoint
{
     ...
     *
     * @throws \Flownative\Kubernetes\Api\Exception\DeleteCoreV1NamespaceUnauthorizedException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (401 === $status) {
            throw new \Flownative\Kubernetes\Api\Exception\DeleteCoreV1NamespaceUnauthorizedException($response);
        }
