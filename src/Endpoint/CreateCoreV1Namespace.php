...
class CreateCoreV1Namespace extends \Flownative\Kubernetes\Api\Runtime\Client\BaseEndpoint implements \Flownative\Kubernetes\Api\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(\Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Namespace $body, array $queryParameters = [])
    {
        $this->body = $body;
     ...
     *
     * @throws \Flownative\Kubernetes\Api\Exception\CreateCoreV1NamespaceUnauthorizedException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (401 === $status) {
            throw new \Flownative\Kubernetes\Api\Exception\CreateCoreV1NamespaceUnauthorizedException($response);
        }
