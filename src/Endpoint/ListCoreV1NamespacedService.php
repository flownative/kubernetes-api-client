...
class ListCoreV1NamespacedService extends \Flownative\Kubernetes\Api\Runtime\Client\BaseEndpoint implements \Flownative\Kubernetes\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{namespace}'], [$this->namespace], '/api/v1/namespaces/{namespace}/services');
    }
     ...
     *
     * @throws \Flownative\Kubernetes\Api\Exception\ListCoreV1NamespacedServiceUnauthorizedException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (401 === $status) {
            throw new \Flownative\Kubernetes\Api\Exception\ListCoreV1NamespacedServiceUnauthorizedException($response);
        }
