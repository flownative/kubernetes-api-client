...
class ListCoreV1Node extends \Flownative\Kubernetes\Api\Runtime\Client\BaseEndpoint implements \Flownative\Kubernetes\Api\Runtime\Client\Endpoint
{
    ...
    /**
     * @return \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1NodeList
     *
     * @throws \Flownative\Kubernetes\Api\Exception\ListCoreV1NodeUnauthorizedException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            return $serializer->deserialize($body, 'Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1NodeList', 'json');
        }
        if (401 === $status) {
            throw new \Flownative\Kubernetes\Api\Exception\ListCoreV1NodeUnauthorizedException($response);
        }
