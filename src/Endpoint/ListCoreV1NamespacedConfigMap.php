...
class ListCoreV1NamespacedConfigMap extends \Flownative\Kubernetes\Api\Runtime\Client\BaseEndpoint implements \Flownative\Kubernetes\Api\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{namespace}'], [$this->namespace], '/api/v1/namespaces/{namespace}/configmaps');
    }
    ...
    /**
     * @return \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1ConfigMapList
     *
     * @throws \Flownative\Kubernetes\Api\Exception\ListCoreV1NamespacedConfigMapUnauthorizedException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            return $serializer->deserialize($body, 'Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1ConfigMapList', 'json');
        }
        if (401 === $status) {
            throw new \Flownative\Kubernetes\Api\Exception\ListCoreV1NamespacedConfigMapUnauthorizedException($response);
        }
