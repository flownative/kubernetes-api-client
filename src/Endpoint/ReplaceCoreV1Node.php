...
class ReplaceCoreV1Node extends \Flownative\Kubernetes\Api\Runtime\Client\BaseEndpoint implements \Flownative\Kubernetes\Api\Runtime\Client\Endpoint
{
     ...
     *             }
     */
    public function __construct(string $name, \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Node $body, array $queryParameters = [])
    {
        $this->name = $name;
        $this->body = $body;
    ...
    {
        return str_replace(['{name}'], [$this->name], '/api/v1/nodes/{name}');
    }
    ...
    /**
     * @return \Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Node
     *
     * @throws \Flownative\Kubernetes\Api\Exception\ReplaceCoreV1NodeUnauthorizedException
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (200 === $status) {
            return $serializer->deserialize($body, 'Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Node', 'json');
        }
        if (201 === $status) {
            return $serializer->deserialize($body, 'Flownative\Kubernetes\Api\Model\IoK8sApiCoreV1Node', 'json');
        }
        if (401 === $status) {
            throw new \Flownative\Kubernetes\Api\Exception\ReplaceCoreV1NodeUnauthorizedException($response);
        }
